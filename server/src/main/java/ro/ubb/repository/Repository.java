...
public interface Repository<ID ,Type extends BaseEntity> {
     ...
     * @throws ValidatorException if the entity id does not exist.
     */
    Optional<Type> update(Type entity) throws ValidatorException;
    /**
     * Deletes an entity with a given id.
     * @param id the id of the entity to delete.
     * @throws ValidatorException if there is no entity with the given id.
     */
    Optional<Type> delete(ID id) throws ValidatorException;
}
